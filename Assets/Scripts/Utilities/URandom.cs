...
{
    public static bool Bool(int chanceTrue = 50) => Random.Range(0, 50) > chanceTrue;
    ...
    public static int[] TwoIndexes { get => two[Random.Range(0, 2)];  }
    private static readonly int[][] two =  { new int[]{ 0, 1 }, new int[]{ 1, 0 } };
